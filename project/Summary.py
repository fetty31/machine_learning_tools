...
parameters = {'learning_rate': np.logspace(-2, 0, 5), 'max_iter': np.logspace(2,3,5, dtype=int), 'max_depth': range(6,12,2)}
...
results.to_csv('project/preliminary_results.csv', index=False)